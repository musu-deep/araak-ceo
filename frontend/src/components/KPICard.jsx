...
export default function KPICard({ label, value, sublabel, accent = "default", icon, testId }) {
  const accents = {
  ...
  return (
    <div data-testid={testId} className={`glass-card p-5 ${accents[accent] || accents.default} hover:translate-y-[-2px] transition-transform`}>
